...
class HomeView extends GetView<HomeController> {
        ...
        body: Obx(
          () => controller.isError.value == true
              ...
              : RefreshIndicator(
                  ...
                  onRefresh: () async {
                    controller.noSearch.value = false;
  ...
  _movies(ThemeData theme) {
    return Expanded(
      child: Padding(
        padding: EdgeInsets.fromLTRB(18.sp, 0.sp, 18.sp, 18.sp),
        child: controller.noSearch.value
            ? EmptyWidget(onPressed: () async {
                controller.noSearch.value = false;
                controller.searchEditingController.clear();
                await controller.getAllMovies();
              })
                    ...
                    InkWell(
                      onTap: () async {
                        if (await NetworkConnectivity.isNetworkAvailable()) {
                          await controller.getMovieDetail(
                              controller.movies[index].id.toString());
